<?php
/**
 * Модуль для работы с авторизационными данными пользователей. Авторизационные данные хранятся в отдельном наборе
 *  стореджей и более нигде. С данным набором происходит работа только при попытке логина. В сессию авторизационные
 *  данные сохраняться ни в коем случае не должны.
 * Авторизационные данные сохраняются в шарды по логину пользователя в алфавитном порядке. Таблица содержит данные,
 *  необходимые для идентификации и авторизации пользователя, его идентификатор
 */
