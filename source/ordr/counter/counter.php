<?php
/**
 * Модуль для работы с общими счетчиками приложения. Обеспечивает атомарный инкреент счечтиков пользователей, заказов
 * Счетчики представленый таблицей. Каждый счетчик имеет имя и текущее значение. Значение счетчика обеспечивает
 *  уникальный распределенный по шардовым базам ключ для данных пользователя, для данных заказа
 */

/**
 * @return array конфигурационные данные стореджа счетчиков
 */
...
/**
 * Фукнция инициализации БД счетчиков
